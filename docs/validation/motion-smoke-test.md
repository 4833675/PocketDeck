...
|---|---|---|---|---|
| MOTION-BUILD-01 | `scripts/test-native.sh` | Native checks pass | Passed | `PASS: 1601 checks` |
| MOTION-BUILD-02 | `pio run -e cardputer-adv` | Target builds | Passed | RAM `104728` bytes; flash `2134157` bytes |
