...
|---|---|---|---|---|
| MOTION-BUILD-01 | `scripts/test-native.sh` | Native checks pass | Passed | `PASS: 1182 checks` |
| MOTION-BUILD-02 | `pio run -e cardputer-adv` | Target builds | Passed | RAM `91080` bytes; flash `2108053` bytes |
