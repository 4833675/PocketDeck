...
| MEDIA-12 | Keep TF diagnostics active during playback | Events remain in the bounded deferred queue; they flush only after playback exits | Pending | |
| MEDIA-13 | With antenna attached, exercise LORA after MEDIA | SX1262 still initializes and shared SPI remains usable | Pending | |
| MEDIA-14 | Start MEDIA with BLE/Wi-Fi master settings enabled | Both indicators become policy-suspended; no advertising, scan, or reconnect loop runs | Pending | |
